...
CND_CONF=Windows__nimm_das_hier_
CND_DISTDIR=dist
CND_BUILDDIR=build
...
OBJECTFILES= \
	...
	${OBJECTDIR}/src/robinglut/levels/level4.o \
...
LDLIBSOPTIONS=-lopengl32 -lglut32
...
${OBJECTDIR}/src/robinglut/player.o: src/robinglut/player.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/robinglut
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/robinglut/player.o src/robinglut/player.cpp

${OBJECTDIR}/src/robinglut/scene.o: src/robinglut/scene.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/robinglut
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/robinglut/scene.o src/robinglut/scene.cpp

${OBJECTDIR}/src/robinglut/glut_renderer.o: src/robinglut/glut_renderer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/robinglut
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/robinglut/glut_renderer.o src/robinglut/glut_renderer.cpp

${OBJECTDIR}/src/robinglut/menu.o: src/robinglut/menu.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/robinglut
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/robinglut/menu.o src/robinglut/menu.cpp

${OBJECTDIR}/src/robinglut/level.o: src/robinglut/level.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/robinglut
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/robinglut/level.o src/robinglut/level.cpp

${OBJECTDIR}/src/robinglut/robin_glut.o: src/robinglut/robin_glut.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/robinglut
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/robinglut/robin_glut.o src/robinglut/robin_glut.cpp
...
${OBJECTDIR}/pfeil.o: pfeil.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/pfeil.o pfeil.cpp
...
${OBJECTDIR}/src/robinglut/levels/level4.o: src/robinglut/levels/level4.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/robinglut/levels
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/robinglut/levels/level4.o src/robinglut/levels/level4.cpp
...
${OBJECTDIR}/src/robinglut/arrow.o: src/robinglut/arrow.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/robinglut
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/robinglut/arrow.o src/robinglut/arrow.cpp

${OBJECTDIR}/src/robinglut/target.o: src/robinglut/target.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/robinglut
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/robinglut/target.o src/robinglut/target.cpp

${OBJECTDIR}/src/robinglut/model.o: src/robinglut/model.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/robinglut
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/robinglut/model.o src/robinglut/model.cpp

${OBJECTDIR}/src/robinglut/heightmap.o: src/robinglut/heightmap.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/robinglut
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/robinglut/heightmap.o src/robinglut/heightmap.cpp
